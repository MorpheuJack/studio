...
**ENTREVISTADO:** Obrigado por me receberem.
...
**ENTREVISTADO:** Eu não pensei originalmente que construiria algo grandioso. Eu queria tentar construir algo útil, mas, se você olhar probabilisticamente, parecia improvável. Mas eu queria pelo menos tentar.
...
**ENTREVISTADO:** Em 95, eu tive a escolha de fazer um PhD em Stanford, trabalhando em ultracapacitores para veículos elétricos, ou tentar fazer algo nessa coisa que a maioria das pessoas nunca tinha ouvido falar chamada internet.
...
**ENTREVISTADO:** Para a minha primeira startup, o grande erro foi ter muito controle acionário e do conselho de empresas de mídia legadas. Elas necessariamente veem as coisas através de suas lentes e fazem você fazer coisas que não fazem sentido com a nova tecnologia.
...
**ENTREVISTADO:** Eu senti que com a Zip2, construímos uma tecnologia incrível que nunca foi realmente usada como deveria. Eu queria fazer algo onde não seríamos limitados por nossos clientes, iríamos direto ao consumidor. E foi isso que a X.com e, depois, o PayPal se tornaram.
...
**ENTREVISTADO:** Eu geralmente acho que se deve tentar ser o mais útil possível. Pode parecer clichê, mas é incrivelmente difícil ser útil para muitas pessoas. Não aspire à glória, aspire ao trabalho.
...
**ENTREVISTADO:** As ferramentas da física são incrivelmente úteis. "Primeiros princípios" significa decompor as coisas nos elementos axiomáticos fundamentais e raciocinar a partir daí, em oposição a raciocinar por analogia.
...
**ENTREVISTADO:** Um grande filtro seria a guerra termonuclear. Outro é a IA. Acho que construir IA benigna que ame a humanidade é crucial. E o mais importante é uma adesão rigorosa à verdade, mesmo que politicamente incorreta. Forçar a IA a acreditar em coisas que não são verdadeiras pode torná-la muito perigosa.
...
**ENTREVISTADO:** Provavelmente teremos um bom resultado. Concordo com Jeff Hinton que há uma chance de 10 a 20% de aniquilação, mas isso significa 80 a 90% de um ótimo resultado. Repito: adesão rigorosa à verdade é a coisa mais importante para a segurança da IA.

**ENTREVISTADOR:** E a Neuralink?

**ENTREVISTADO:** A Neuralink não é necessária para a superinteligência digital, que virá antes. Mas ela resolve o problema da largura de banda entre cérebro e máquina. Nossa saída de dados é muito baixa. Com a Neuralink, poderemos aumentar massivamente a entrada e saída. Já temos humanos com implantes de "leitura". Em breve, faremos implantes para visão, permitindo que cegos vejam, e no futuro, com superpoderes como visão infravermelha. Mas a superinteligência digital acontecerá bem antes disso.
